...
// @ui {"widget":"group_end"}
// @ui {"widget":"separator"}
// @ui {"widget":"group_start", "label":"Image to Text Example"}
// @input Asset.Texture imageToReadTexture
// @input string imageToTextPrompt = "Can you read what's in this image? give me the output as a text, " {"widget":"text_area"}
// @input bool doImageToTextOnTap {"label":"Run On Tap"}
// @ui {"widget":"group_end"}
// @ui {"widget":"separator"}
...
var Module = require("../../../../../../Modules/Src/Assets/RemoteServiceGateway.lspkg/HostedExternal/Examples/OpenAI_New");
...
awakeEvent.bind(() => {
    ...
    checkUndefined("imageToReadTexture", []);
    checkUndefined("imageToTextPrompt", []);
    checkUndefined("doImageToTextOnTap", []);
